...
public class GenerateCategories {
	...
	public static final String[] EXPENSES_TYPE = { "expenses", "Charitable Giving", "Gifts", "Automotive/Fuel", "Healthcare/Medical",
			"Insurance", "Office Expenses", "Services/Supplies", "Postage/Shipping", "Taxes", "Other Expenses",
			"Check Payment", "Service Charges/Fees", "Home Improvement", "Electronics/General Merchandise",
			"Groceries", "Pets/Pet Care", "Mortage", "Rent", "Loans", "Utilities", "Cable/Satellite/Telecom",
			"Personal/Family", "ATM/Cash Withdraws", "Education", "Subscriptions/Renewals", "Restaurants",
	...
	public static final String[] TRANSFER_TYPE = { "transfer", "Transfers", "Securities Trades", "Saving", "Credit Card Payments" };
	...
	public static void populateCategories(String[] categories) {
		...
		for (String name : categories) {
			...
			Category category;
			try {
				category = em.createQuery("select c from Category c where c.name=:name" , Category.class).setParameter("name", name).getSingleResult();
